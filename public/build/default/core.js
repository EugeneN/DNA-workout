/* Cafe 0.0.88 Mon Feb 11 2013 18:02:51 GMT+0200 (EET) */
...
(function() {
  ...
  is_async = function(ns, method_name) {
    var args, async, m, name, _ref, _ref1;
    ...
    if (m) {
      _ref1 = m[0], name = _ref1[0], args = _ref1[1], async = _ref1[2];
      return async === 'async';
    } else {
      return null;
    }
  ...
  get_arity = function(ns, method_name) {
    var argums, async, m, name, _ref, _ref1;
    m = (_ref = Protocols[ns]) != null ? _ref.filter(function(_arg) {
      var mn;
      mn = _arg[0];
      return mn === method_name;
    ...
    if (m) {
      _ref1 = m[0], name = _ref1[0], argums = _ref1[1], async = _ref1[2];
    ...
    for (modname in bootstrapper.modules) {
      ...
      if (exports.protocols && exports.protocols.implementations) {
        _results.push((function() {
          var _ref1, _results1;
          _ref1 = exports.protocols.implementations;
          _results1 = [];
...
'index': function(exports, require, module) {(function() {
(function() {
  var CELLS, DA_EXTEND, DA_SUBSCRIBE, DEBUG, DNA_DATATYPES, THIS, async_map, bool, compose2, cont_m, cont_t, default_handlers_cont, dispatch_handler, dispatch_handler_fn, dispatch_impl, domonad, find_cell, get_arity, get_cell, get_create_cell, get_create_cell_by_id, get_default_protocols, get_method_ns, get_protocol, interpose_handlers_with_events, is_array, is_async, is_data, is_handler, is_null, is_object, lift, lift_async, lift_sync, logger_m, logger_t, make_extended_node, make_monadized_handler, make_subscribed_node, maybe_m, maybe_t, parse_ast_handler_node, parse_genome, partial, register_protocol_impl, save_cell, say, saynull, synthesize_cell, synthesize_node, _ref, _ref2;
  ...
  async_map = function(vector, cell, dom_parser, cont) {
    ...
    return vector.map(function(i, idx) {
      var h, _ref3;
      if (_ref3 = i.type, __indexOf.call(DNA_DATATYPES, _ref3) >= 0) {
        count--;
  ...
  is_data = function(method) {
    var _ref3;
    return _ref3 = method.type, __indexOf.call(DNA_DATATYPES, _ref3) >= 0;
  };
  ...
  synthesize_cell = function(node, protocols, dom_parser) {
    ...
    if (!node.id) {
      node.id = (dom_parser.get_id(node)) || 'Z' + Math.uuid().replace(/-/g, '_');
    }
    proto_cell = {
      id: node.id,
      node: node,
  ...
  parse_ast_handler_node = function(handler, current_cell, dom_parser) {
    var cell, cell_id, handler_arity, handler_fn, handler_is_async, handler_ns, method, ns, real_handler, scope, _ref3;
    _ref3 = is_array(handler) ? handler[0] : handler, ns = _ref3.ns, method = _ref3.method, scope = _ref3.scope;
  ...
  interpose_handlers_with_events = function(dom_parser, cell, handlers, evs_args) {
    var args, event, ns, raw_args, scope, _ref3, _ref4;
    _ref3 = is_array(evs_args) ? evs_args : [evs_args, []], (_ref4 = _ref3[0], ns = _ref4.ns, event = _ref4.event, scope = _ref4.scope), raw_args = 2 <= _ref3.length ? __slice.call(_ref3, 1) : [];
    args = (raw_args.filter(function(a) {
      var _ref5;
      return _ref5 = a.event.type, __indexOf.call(DNA_DATATYPES, _ref5) >= 0;
    })).map(function(a) {
      return a.event.value;
    });
    return handlers.map(function(handlr) {
      var _ref5;
      return (_ref5 = dispatch_handler(ns != null ? ns.name : void 0, event.name, find_cell((scope != null ? scope.name : void 0) || THIS, cell, dom_parser))).impl.apply(_ref5, args.concat([handlr]));
    });
  };
